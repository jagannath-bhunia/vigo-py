...
(function (global, factory) {
  ...
  var PushMenu = function ($) {
    ...
    var Selector = {
      ...
      WRAPPER: '.wrapper',
      FULL_LOGO: '#stretchedLogo',
      SHORT_LOGO: '#collapsedLogo'
    };
    var ClassName = {
      ...
      _proto.expand = function expand() {
        if (this._options.autoCollapseSize) {
          if ($(window).width() <= this._options.autoCollapseSize) {
            ...
            $(Selector.SHORT_LOGO).css({'display': 'none'});
            $(Selector.FULL_LOGO).css({'display': 'block'});
          }else{
              $(Selector.SHORT_LOGO).css({'display': 'none'});
              $(Selector.FULL_LOGO).css({'display': 'block'});
          }
        ...
        if (this._options.autoCollapseSize) {
          if ($(window).width() <= this._options.autoCollapseSize) {
            ...
            $(Selector.SHORT_LOGO).css({'display': 'none'});
              ...
              $(Selector.FULL_LOGO).css({'display': 'none'});
              $(Selector.SHORT_LOGO).css({'display': 'block'});
          }
        }
