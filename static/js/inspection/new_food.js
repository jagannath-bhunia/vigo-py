...
function saveInspectionDetails(inspectionId){
    $('div.panel').each(function(){
        ...
        var image2 = $('#image2_'+item_id)[0].files[0];
        ...
        for(let i=1;i<=5;i++){
            ...
            formData.append('comment_' + i + '_' + item_id, $('#comment_' + i + '_' + item_id).val());
        ...
        if(comment!="" || typeof image!="undefined" || out!="" || inbtn!="" || no!=""
                        || na!="" || cos!="" || r!="" || typeof image2!="undefined" )
        {
            $.ajax({
...
function saveNewFoodTemp(inspection_id)
{
    ...
    $.ajax({
        ...
        url: adult_day_care_temperature_submit_route,
        type: "POST",
        data: {
